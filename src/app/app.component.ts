...
// 1. cant be pushed same item name // DONE!!!!!!!!!!!!!!!!!!!!!!
// 3. if an item which will be inputted in an array, if the name of the inputted name is in the other array, the other array name will be colored // DONE!!!!!!!!!!!!!!!!!!!!!!
// 4. if an item is deleted or pushed to another array the selected color will be gone // DONE!!!!!!!!!!!!!!!!!!!!!!
// 5. styling problems
